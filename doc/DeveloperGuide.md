...
`* * *` | user | update a person details | keep the information up to date
...
`* *` | user | find every person who has the specific tag | find a person according to the tag
...
2. AddressBook ask for a confirmation for the renaming request
...
> 2a2. AddressBook refer user to step 1
  Use case resumes at step 2
...
5. GUI should user-friendly and intuitive.
6. Should have quick response time.
